...
```
DEPLOY_ENV=prod
DEPLOY_HOST=312.deporeibar.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for 312.deporeibar.com, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/312.deporeibar.com.yml` to the remote server with:
