      ...
      {content.egindako_eguna ? (
        <p>
          <strong>              <FormattedMessage
                id="igoeraEguna"
                defaultMessage="Igoera eguna"
              /></strong>: <Eguna date={content.egindako_eguna} />
        </p>
      ) : (
        <p>
          <strong>              <FormattedMessage
              ...
              /></strong>: <Eguna date={content.eguna} />
        </p>
      )}
      ...
      {content.mendizaleak ? (
        ...
        <p>
          <strong>              <FormattedMessage
              ...
              /></strong>: {userData[content.creators[0]]}
        </p>
      )}
